...
# Clock Signal
Clock Signal ('CLK') is an emulator for tourists that seeks to be invisible. Users directly launch classic software, usually avoiding the learning curve associated with emulators and with emulated machines.
