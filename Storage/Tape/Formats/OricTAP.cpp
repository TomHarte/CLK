...
OricTAP::OricTAP(const std::string_view file_name) : file_name_(file_name) {
...
OricTAP::Serialiser::Serialiser(const std::string_view file_name) : file_(file_name, FileMode::Read) {
	reset();
}
