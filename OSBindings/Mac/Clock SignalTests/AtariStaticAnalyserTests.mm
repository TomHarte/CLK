...
static NSDictionary<NSString *, AtariROMRecord *> *romRecordsBySHA1 = @{
	...
	Record(@"e4134a3b4a065c856802bc935c12fa7e9868110a", None, NO)		// Battlezone
	Record(@"47619edb352f7f955f811cbb03a00746c8e099b1", None, NO)		// Beamrider
	...
	Record(@"5e4517db83c061926130ab65975e3b83d9401cc9", None, NO)		// Big Bird's Egg Catch
	Record(@"512e4d047f1f813bc805c8d2a5f7cbdb34b9ea46", None, NO)		// bin00016
	Record(@"f6a41507b8cf890ab7c59bb1424f0500534385ce", None, NO)		// Bionic Breakthrough
	Record(@"edfd905a34870196f8acb2a9cd41f79f4326f88d", None, NO)		// Blackjack
	Record(@"0fadef01ce28192880f745b23a5fbb64c5a96efe", None, NO)		// Blueprint
	...
	Record(@"9c0e13af336a986c271fe828fafdca250afba647", None, NO)		// Bugs Bunny
	...
	Record(@"609c20365c3a71ce45cb277c66ec3ce6b2c50980", None, NO)		// California Games
	...
	Record(@"0b5914bc1526a9beaf54d7fd11408175cd8fcc72", None, NO)		// Centipede
	...
	Record(@"68a7cb3ff847cd987a551f3dd9cda5f90ce0a3bf", None, NO)		// Commando
	...
	Record(@"f4a62ba0ff59803c5f40d59eeed1e126fe37979b", None, NO)		// Cookie Monster Munch
	...
	Record(@"70e723aa67d68f8549d9bd8f96d8b1262cbdac3c", None, NO)		// Crazy Climber
	...
	Record(@"5da3d089ccda960ce244adb855975877c670e615", None, NO)		// Crossbow
	Record(@"a57062f44e7ac793d4c39d1350521dc5bc2a665f", None, NO)		// Crypts of Chaos
	Record(@"2e4ee5ee040b08be1fe568602d1859664e607efb", None, NO)		// Crystal Castles
	...
	Record(@"fbb4814973fcb4e101521515e04daa6424c45f5c", None, NO)		// Dark Chambers
	...
	Record(@"717656f561823edaa69240471c3106963f5c307e", None, NO)		// Decathlon
	Record(@"d7b506b84f28e1b917a2978753d5a40eb197537a", None, NO)		// Defender 2
	...
	Record(@"ccea2d5095441d7e1b1468e3879a6ab556dc8b7a", None, NO)		// Desert Falcon
	...
	Record(@"79e746524520da546249149c33614fc23a4f2a51", None, NO)		// Dig Dug
	...
	Record(@"4606c0751f560200aede6598ec9c8e6249a105f5", None, NO)		// Donald Duck's Speedboat
	Record(@"359e662da02bf0a2184472e25d05bc597b6c497a", None, NO)		// Donkey Kong (1983) (CBS Electronics) (PAL) [!]
	Record(@"98f98ac0728c68de66afda6500cafbdffe8ab50a", None, NO)		// Donkey Kong Junior
	Record(@"6e6e37ec8d66aea1c13ed444863e3db91497aa35", None, NO)		// Donkey Kong
	Record(@"251e02ac583d84eb43f1451d55b62c7c70e9644f", None, NO)		// Double Dragon
	Record(@"8e2ea320b23994dc87abe69d61249489f3a0fccc", None, NO)		// Double Dunk
	...
	Record(@"c061d753435dcb7275a8764f4ad003b05fa100ed", None, NO)		// Dukes of Hazzard (1983)
	Record(@"d16eba13ab1313f375e86b488181567f846f1dc4", None, NO)		// Dumbo's Flying Circus
	Record(@"9e34f9ca51573c92918720f8a259b9449a0cd65e", None, NO)		// E.T. — The Extra-Terrestrial
	...
	Record(@"d0bb58ea1fc37e929e5f7cdead037bb14a166451", None, NO)		// Fatal Run
	Record(@"686427cc47b69980d292d04597270347942773ff", None, NO)		// Fathom
	Record(@"684275b22f2bac7d577cf48cf42fa14fa6f69678", None, NO)		// Fighter Pilot
	...
	Record(@"de6fc1b51d41b34dcda92f579b2aa4df8eccf586", None, NO)		// Frog Pond
	...
	Record(@"cf32bfcd7f2c3b7d2a6ad2f298aea2dfad8242e7", None, NO)		// Front Line
	...
	Record(@"8e708e0067d3302327900fa322aeb8e2df2022d7", None, NO)		// Galaxian Enhanced Graphics
	Record(@"b081b327ac32d951c36cb4b3ff812be95685d52f", None, NO)		// Galaxian
	...
	Record(@"5ed0b2cb346d20720e3c526da331551aa16a23a4", None, NO)		// Ghostbusters
	...
	Record(@"a372d4dd3d95b3866553cae2336e4565e00cc25b", None, NO)		// Gravitar
	Record(@"7a027329309e018b0d51adcb6ae13c9d13e54f4a", None, NO)		// Gremlins
	Record(@"c90acaee066f97efc6a520deb7fa3e5760a471fa", None, NO)		// Grover's Music Maker
	...
	Record(@"282f94817401e3725c622b73a0c05685ce761783", None, NO)		// H.E.R.O.
	...
	Record(@"8196209ef7048c5494dbdc932adbf1c7abf79f4e", None, NO)		// Holey Moley
	...
	Record(@"e5b9c3a3638bd42f96a26b651463da96a9432315", None, NO)		// Ikari Warriors
	...
	Record(@"cb94dc316cba282a0036871db2417257e960786b", None, NO)		// Joust
	Record(@"cd2cf245d6e924ff2100cc93d20223c4a231e160", None, NO)		// Jr. Pac-Man
	Record(@"9a0ee845d9928d4db003b07b927bb2c1f628e725", None, NO)		// Jungle Fever
	Record(@"83a32a2d686355438c915540cfe0bb13b76c1113", None, NO)		// Jungle Hunt
	...
	Record(@"01fd30311e028944eafb6d14bb001035f816ced7", None, NO)		// Kangaroo
	...
	Record(@"3162259c6dbfbb57a2ea41d849155702151ee39b", None, NO)		// Klax
	...
	Record(@"4bdf1cf73316bdb0002606facf11b6ddcb287207", None, NO)		// Krull
	Record(@"1637b6b9cd1a918339ec054cf95b924e7ce4789a", None, NO)		// Kung Fu Superkicks
	Record(@"3b93a34ba2a6b7db387ea588c48d939eee5d71a1", None, NO)		// Kung-Fu Master
	...
	Record(@"49425ff154b92ca048abb4ce5e8d485c24935035", None, NO)		// Mario Bros.
	...
	Record(@"7fcf95459ea597a332bf5b6f56c8f891307b45b4", None, NO)		// Midnight Magic
	Record(@"0616f0dde6d697816dda92ed9e5a4c3d77a39408", None, NO)		// Millipede
	...
	Record(@"dce778f397a325113f035722b7769492645d69eb", None, NO)		// Moon Patrol
	Record(@"05ab04dc30eae31b98ebf6f43fec6793a53e0a23", None, NO)		// Moonsweeper
	Record(@"c4d495d42ea5bd354af04e1f2b68cce0fb43175d", None, NO)		// Motocross Racer
	Record(@"ece97bda734faffcf847a8bcdfa474789c377d8d", None, NO)		// MotoRodeo
	Record(@"ef4112e86d6a3e8f7b8e482d294a5917f162b38c", None, NO)		// Mountain King
	Record(@"cf6347dedcfec213c28dd92111ec6f41e74b6f64", None, NO)		// Mouse Trap
	Record(@"e4c912199779bba25f1b9950007f14dca3d19c84", None, NO)		// Mr Do!
	Record(@"330c2c67399e07c40f4101f9e18670fef070475e", None, NO)		// Mr. Do!'s Castle
	Record(@"62b933cdd8844bb1816ce57889203954fe782603", None, NO)		// Ms. Pac-Man
	Record(@"b2df23b1bf6df9d253ad0705592d3fce352a837b", None, NO)		// My Golf
	...
	Record(@"be3f4beeb322cddc7223d6d77e17302aa811e43a", None, NO)		// Obelix
	Record(@"1f8d06b99db94b0aa8ca320c7cb212639ac9591f", None, NO)		// Ocean City
	Record(@"3dcfe93399044148561586056288c6f8e5c96e2b", None, NO)		// Off the Wall
	...
	Record(@"dcaab259e7617c7ac7d349893451896a9ca0e292", None, NO)		// Omega Race
	Record(@"cd968c2a983f9adf4d8d8d56823923b31c33980f", None, NO)		// Open Sesame
	Record(@"7905709fcc85cbcfc28ca2ed543ffa737a5483ae", None, NO)		// Oscar's Trash Race
	...
	Record(@"461c2ea3e4d24f86ec02215c1f4743d250796c11", None, NO)		// Pengo (prototype)
	Record(@"89b991a7a251f78f422bcdf9cf7d4475fdf33e97", None, NO)		// Pengo
	...
	Record(@"010d51e3f522ba60f021d56819437d7c85897cdd", None, NO)		// Phoenix
	...
	Record(@"d08b30ca2e5e351cac3bd3fb760b87a1a30aa300", None, NO)		// Pigs in Space
	...
	Record(@"9d334da07352a9399cbbd9b41c6923232d0cdcd3", None, NO)		// Pole Position
	...
	Record(@"8b001373be485060f88182e9a7afcf55b4d07a57", None, NO)		// Pressure Cooker
	Record(@"1ea6bea907a6b5607c76f222730f812a99cd1015", None, NO)		// Private Eye
	...
	Record(@"1e634a8733cbc50462d363562b80013343d2fac3", None, NO)		// Quadrun
	...
	Record(@"33f016c941fab01e1e2d0d7ba7930e3bcd8feaa3", None, NO)		// Radar Lock
	...
	Record(@"7ae70783969709318e56f189cf03da92320a6aba", None, NO)		// Raiders of the Lost Ark
	Record(@"fd0a69c06eb3f7c9328951c890644f93c4bad6ad", None, NO)		// Ram It
	Record(@"7bb7df255829d5fbbee0d944915e50f89a5e7075", None, NO)		// Rampage!
	Record(@"5adf9b530321472380ebceb2539de2ffbb0310bc", None, NO)		// Reactor
	Record(@"ace97b89b8b6ab947434dbfd263951c6c0b349ac", None, NO)		// RealSports Baseball
	Record(@"bc2e6bdaa950bc06be040899dfeb9ad0938f4e98", None, NO)		// RealSports Basketball
	Record(@"22dedbfce6cc9055a6c4caec013ca80200e51971", None, NO)		// RealSports Boxing
	Record(@"200d04c1e7f41a5a3730287ed0c3f9293628f195", None, NO)		// RealSports Football
	Record(@"e3d964d918b7f2c420776acd3370ec1ee62744ea", None, NO)		// RealSports Soccer
	Record(@"702c1c7d985d0d22f935265bd284d1ed50df2527", None, NO)		// RealSports Tennis
	...
	Record(@"a08c3eae3368334c937a5e03329782e95f7b57c7", None, NO)		// River Raid II
	...
	Record(@"f45dfcd6db0dae5458e1c0ae8eeaa75b553cdfec", None, NO)		// Road Runner
	Record(@"21a3ee57cb622f410ffd51986ab80acadb8d44b7", None, NO)		// Robot Tank
	Record(@"0abf0a292d4a24df5a5ebe19a9729f3a8f883c8b", None, NO)		// Roc 'n Rope
	Record(@"fd243c480e769b20b7bf3e74bcd86e4ac99dab19", None, NO)		// Room of Doom
	Record(@"85752ac6eb7045a9083425cd166609882a1c2c58", None, NO)		// Saboteur
	Record(@"ecd8ef49ae23ddd3e10ec60839b95c8e7764ea27", None, NO)		// Save Mary!
	...
	Record(@"af11f1666d345267196a1c35223727e2ef93483a", None, NO)		// Secret Quest
	Record(@"6518078b3786ac26f75067f0646aef4e83f2db15", None, NO)		// Self_Portrait_by_Tjoppen
	Record(@"fcf5f8a7d6e59a339c2002e3d4084d87deb670fe", None, NO)		// Sentinel
	...
	Record(@"6e6daa34878d3e331c630359c7125a4ffba1b22d", None, NO)		// Shooting Arcade
	Record(@"08952192ea6bf0ef94373520a7e855f58bae6179", None, NO)		// Shuttle Orbiter
	Record(@"242fc23def80da96da22c2c7238d48635489abb0", None, NO)		// Sinistar
	...
	Record(@"c0ae3965fcfab0294f770af0af57d7d1adc17750", None, NO)		// Smurfs Save the Day
	...
	Record(@"972bc0a77e76f3e4e1270ec1c2fc395e9826bc07", None, NO)		// Snoopy and the Red Baron
	Record(@"9d725002e94b04e29d8cbce3c71d3bb2a84352fa", None, NO)		// Soccer
	Record(@"09ea74f14db8d21ea785d0c8209ed670e4ce88be", None, NO)		// Solar Fox
	Record(@"ec65ef9e47239a7d15db9bca7e625b166e8ac242", None, NO)		// Solar Storm
	Record(@"33b16fbc95c2cdc52d84d98ca471f10dae3f9dbf", None, NO)		// Solaris
	Record(@"ae3009e921f23254bb71f67c8cb2d7d6de2845a5", None, NO)		// Sorceror's Apprentice
	...
	Record(@"bcec5a66f8dff1a751769626b0fce305fab44ca2", None, NO)		// Space Shuttle
	...
	Record(@"c0e29b86fc1cc41a1c8afa37572c3c5698ae70b2", None, NO)		// Sprint Master
	...
	Record(@"e10cce1a438c82bd499e1eb31a3f07d7254198f5", None, NO)		// Star Raiders
	...
	Record(@"4f87be0ef16a1d0389226d1fbda9b4c16b06e13e", None, NO)		// Stargate
	...
	Record(@"65f4a708e6af565f1f75d0fbdc8942cb149cf299", None, NO)		// Summer Games
	Record(@"b066a60ea1df1db0a55271c7608b0e19e4d18a1e", None, NO)		// Super Baseball
	...
	Record(@"eaca6b474fd552ab4aaf75526618828165a91934", None, NO)		// Super Football
	...
	Record(@"05db3d09fa3dac80c70aae2e39f1ad7c31c62f02", None, NO)		// SwordQuest — EarthWorld
	Record(@"5c3cf976edbea5ded66634a284787f965616d97e", None, NO)		// SwordQuest — FireWorld
	Record(@"569fcb67ca1674b48e2f3a2e7af7077a374402de", None, NO)		// SwordQuest — WaterWorld
	...
	Record(@"476f0c565f54accecafd72c63b0464f469ed20ea", None, NO)		// Taz
	...
	Record(@"387358514964d0b6b55f9431576a59b55869f7ab", None, NO)		// Time Pilot
	...
	Record(@"d82ac7237df54cc8688e3074b58433a7dd6b7d11", None, NO)		// Tooth Protectors
	Record(@"b344b3e042447afbb3e40292dc4ca063d5d1110d", None, NO)		// Towering Inferno
	Record(@"005a6a53f5a856f0bdbca519af1ef236aaa1494d", None, NO)		// Track and Field
	...
	Record(@"fc1a0b58765a7dcbd8e33562e1074ddd9e0ac624", None, NO)		// Tunnel Runner
	...
	Record(@"01475d037cb7a2a892be09d67083102fa9159216", None, NO)		// Vanguard
	...
	Record(@"16df34446af2e6035ca871a00e1e8a008cfb8df4", None, NO)		// Wing War
	Record(@"6850d329e8ab403bdae38850665a2eff91278e92", None, NO)		// Winter Games
	...
	Record(@"160b6e36437ad6acbc2686fbde1002e2fa88c5fb", None, NO)		// Xenophobe
	Record(@"73133b81196e5cbc1cec99eefc1223ddb8f4ca83", None, NO)		// Xevious
	...
	Record(@"58c2f6abc5599cd35c0e722f24bcc128ac8f9a30", None, NO)		// Zaxxon
};
#undef Record
