...
template <Page page> auto capture(const uint8_t opcode) {
	...
	addressingMode:(AddressingMode)expectedMode
{
	...
	XCTAssertEqual(expectedOperation, operation.operation, "Operation didn't match for opcode 0x%02x in page %d", opcode, int(page));
	XCTAssertEqual(expectedMode, operation.mode, "Mode didn't match for opcode 0x%02x in page %d", opcode, int(page));
}
...
- (void)testMap {
	...
	[self testOpcode:0x3c page:Page::Page0 isOperation:Operation::CWAI addressingMode:AddressingMode::Specialised];
	...
	[self testOpcode:0x34 page:Page::Page0 isOperation:Operation::PSHS addressingMode:AddressingMode::Specialised];
	[self testOpcode:0x36 page:Page::Page0 isOperation:Operation::PSHU addressingMode:AddressingMode::Specialised];
	[self testOpcode:0x37 page:Page::Page0 isOperation:Operation::PULU addressingMode:AddressingMode::Specialised];
	...
	[self testOpcode:0x3b page:Page::Page0 isOperation:Operation::RTI addressingMode:AddressingMode::Specialised];
	[self testOpcode:0x39 page:Page::Page0 isOperation:Operation::RTS addressingMode:AddressingMode::Specialised];
	...
	[self testOpcode:0x3f page:Page::Page0 isOperation:Operation::SWI addressingMode:AddressingMode::Specialised];
	[self testOpcode:0x3f page:Page::Page1 isOperation:Operation::SWI2 addressingMode:AddressingMode::Specialised];
	[self testOpcode:0x3f page:Page::Page2 isOperation:Operation::SWI3 addressingMode:AddressingMode::Specialised];
